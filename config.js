...
var getConfig = module.exports = function () {
    return {
        ...
        gcloud: {
            projectId: process.env.GCLOUD_PROJECT || 'roderick-1268'
        },

        // Typically you will create a bucket with the same name as your project ID.
        cloudStorageBucket: process.env.CLOUD_BUCKET || 'roderick-1268',
...
if (!projectId || projectId === 'roderick-1268') {
    throw new Error('You must set the GCLOUD_PROJECT env var or add your ' +
    'project id to config.js!');
}

if (!cloudStorageBucket || cloudStorageBucket === 'roderick-1268') {
